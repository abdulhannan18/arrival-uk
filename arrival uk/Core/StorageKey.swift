...
enum StorageKey: String {
    ...
    case taskSyncClientID = "tasks.sync.client.id.v1"
    case taskSyncDeviceID = "tasks.sync.device.id.v1"
    case taskSyncOperationOrdinal = "tasks.sync.operation.ordinal.v1"
    ...
    case collaborationRoomState = "collaboration.room.state.v1"
    case collaborationActiveRoomIDs = "collaboration.rooms.active.v1"
    ...
    case marketplaceEntitlements = "marketplace.entitlements.v1"
